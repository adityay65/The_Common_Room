...
// --- Data Arrays --- //
const teamMembers = [
  { name: 'Dhruv Agarwal', role: 'Founder & CEO', imageUrl: '/images/Dhruv.jpeg' },
  { name: 'Aditi Dabra', role: 'Lead Developer', imageUrl: '/images/Aditi.jpeg' },
  { name: 'Aditya Yadav', role: 'Community Manager', imageUrl: '/images/Aditya.jpeg' },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <img
            ...
            key={currentIndex}
            onError={(e) => { e.currentTarget.src = 'https://placehold.co/600x700/E2E8F0/4A5568?text=Image+Not+Found'; }}
          />
        </div>
      </div>
    </section>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`w-full bg-gray-800 text-white font-bold py-3 px-4 rounded-lg hover:bg-gray-700 transition-colors duration-300 ${state.submitting ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
  ...
  return (
    <div className="bg-white text-gray-800 font-sans">
      ...
      <section className="container mx-auto px-6 py-16 md:py-24 text-center">
        ...
        <div className="w-20 h-1 bg-gray-800 mx-auto mt-4 mb-2"></div>
        <p className="text-gray-600 mb-12">The journey of a thousand miles begins with a single step.</p>
            ...
            <div key={member.name} className="group">
              <div className="relative overflow-hidden rounded-lg aspect-square">
                <img
                  ...
                  src={member.imageUrl}
                  alt={member.name}
                  onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x400/E2E8F0/4A5568?text=Error'; }}
                />
              </div>
