...
const handleEmojiClick = (emojiData: EmojiClickData) => {
  ...
  const newText =
    (bio || '')?.slice(0, cursorPos) + emojiData.emoji + (bio || '').slice(cursorPos);
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-10 pr-3 py-2 border border-gray-400 rounded-md shadow-sm sm:text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 ${
                        !user?.name || name !== user.name ? 'text-gray-900' : 'text-gray-500'
                      }`}
                    />
                  </div>
                </div>
                  ...
                  <div>
                      ...
                      <div className="relative">
                        ...
                        {showEmojiPicker && (
                          ...
                          {/* Character counter */}
                      <p className="text-sm text-gray-500 mt-1">{140 - (bio?.length || 0)} characters remaining</p>
                    </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-10 pr-3 py-2 border border-gray-400 rounded-md shadow-sm sm:text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 ${
                        hobbies && hobbies !== user?.hobbies ? 'text-gray-900' : 'text-gray-500'
                      }`}
                    />
                  </div>
                </div>
          ...
          >
            <form onSubmit={handleChangePassword}>
              ...
              <div className="mt-4 space-y-4">
                {passwordError && (
                  <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 rounded-md text-sm">{passwordError}</div>
                )}
                {passwordSuccess && (
                  <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-3 rounded-md text-sm">{passwordSuccess}</div>
                )}
